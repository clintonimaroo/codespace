          ...
          {blogs.docs.slice(0, 1).map((blog) => (
            <div key={blog.id} className="bg-[#FAFAFA] rounded-[22px] p-8 md:p-12">
              <div className="space-y-4">
                ...
                <Link
                  href={`/blog/${blog.id}`}
                  className="group inline-flex items-center text-primary hover:text-primary/90 transition-colors font-bold"
                >
                  Read the story
                  <svg width={20} height={20} viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-2 rotate-180 transition-all duration-300 transform group-hover:translate-x-2 stroke-2">
                    <path strokeWidth="3" d="M13 5.6C13.3314 5.6 13.6 5.33137 13.6 5C13.6 4.66863 13.3314 4.4 13 4.4V5.6ZM0.575736 4.57574C0.341421 4.81005 0.341421 5.18995 0.575736 5.42426L4.39411 9.24264C4.62843 9.47696 5.00833 9.47696 5.24264 9.24264C5.47696 9.00833 5.47696 8.62843 5.24264 8.39411L1.84853 5L5.24264 1.60589C5.47696 1.37157 5.47696 0.991674 5.24264 0.757359C5.00833 0.523045 4.62843 0.523045 4.39411 0.757359L0.575736 4.57574ZM13 4.4H1V5.6H13V4.4Z" fill="currentColor" />
                  </svg>
                </Link>
              </div>
            </div>
