...
const JoinSection = () => {
  return (
    <Container className="container flex flex-col md:flex-row items-center justify-between py-20 mt-7 mb-20">
      <div className="space-y-5 flex flex-col max-w-xl flex-grow">
