...
const ShareableTakeaway = ({ children }: { children: React.ReactNode }) => {
    ...
    return (
        <div className="block md:hidden my-12 p-8 bg-[#F8FAFC] rounded-lg">
            <div className="text-[#475467] text-sm font-medium tracking-wider uppercase mb-3">
                Shareable Takeaway
            </div>
            <div className="text-[#111827] text-[22px] leading-normal mb-8">
                {children}
            </div>
            <div className="flex flex-col gap-3">
                <a
                    href={`whatsapp://send?text=${shareText}%0A%0A${shareUrl}`}
                    className="flex items-center justify-center h-12 bg-[#25D366] text-white text-base font-medium rounded no-underline hover:opacity-90 transition-all"
                >
                ...
                <a
                    ...
                    className="flex items-center justify-center h-12 bg-[#1877F2] text-white text-base font-medium rounded no-underline hover:opacity-90 transition-all"
                >
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center h-12 bg-[#1DA1F2] text-white text-base font-medium rounded no-underline hover:opacity-90 transition-all"
                >
                    <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
